    ...
    return (
        <div className="pt-10 pb-10 ">
            ...
            <div className="grid grid-cols-1 justify-items-center sm:grid-cols-2 lg:grid-cols-3 gap-6 content">
                ...
                <div className="flex sm:flex-col justify-center items-center gap-2 dark:text-white max-w-md w-full p-5 rounded-md mt-4 shadow-md hover:scale-105 hover:duration-150 duration-150 border-8 border-dashed border-neutral-900 cursor-pointer">
